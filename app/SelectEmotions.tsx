...
const RECENTLY_USED = [
  { id: 1, image: require('assets/icons/neutral-face.png'), name: 'Confused' },
  { id: 2, image: require('assets/icons/neutral-face.png'), name: 'Excited' },
  { id: 3, image: require('assets/icons/neutral-face.png'), name: 'Cool' },
  { id: 4, image: require('assets/icons/neutral-face.png'), name: 'Surprised' },
  { id: 5, image: require('assets/icons/neutral-face.png'), name: 'Peaceful' },
  { id: 6, image: require('assets/icons/neutral-face.png'), name: 'Amazed' },
];

const ALL_EMOTIONS = [
  { id: 7, image: require('assets/icons/neutral-face.png'), name: 'Aww' },
  { id: 8, image: require('assets/icons/neutral-face.png'), name: 'Happy' },
  { id: 9, image: require('assets/icons/neutral-face.png'), name: 'Cool' },
  { id: 10, image: require('assets/icons/neutral-face.png'), name: 'Stressed' },
];
